...
namespace MyLayercake.Sql {
	...
	public class DbCommandBuilder : IDbCommandBuilder {
		...
		/// <returns></returns>
		public virtual IDbCommand GetSelectCommand(Query.Query query) {
			var cmd = GetCommand();
		...
		internal string BuildSelectInternal(Query.Query query, ISqlExpressionBuilder sqlBuilder, bool isSubquery) {
		...
		public virtual IDbCommand GetDeleteCommand(Query.Query query) {
			var cmd = GetCommand();
		...
		public virtual IDbCommand GetUpdateCommand(Query.Query query, IEnumerable<KeyValuePair<string, IQueryValue>> data) {
			var cmd = GetCommand();
			var dbSqlBuilder = GetSqlBuilder(cmd);

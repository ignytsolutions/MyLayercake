...
namespace MyLayercake.Sql {
	...
	public class DbDataView {
		...
		public virtual string FormatSelectSql(Query.Query query, ISqlExpressionBuilder sqlBuilder, bool isSubquery) {
		...
		string BuildWhere(Query.Query query, ISqlExpressionBuilder sqlBuilder) {
		...
		string BuildOrderBy(Query.Query query, ISqlExpressionBuilder sqlBuilder) {
		...
		string BuildSelectColumns(Query.Query query, ISqlExpressionBuilder sqlBuilder) {
			// Compose fields part
		...
		string BuildGroupBy(Query.Query query, ISqlExpressionBuilder sqlBuilder) {
		...
		bool IsCountQuery(Query.Query q) {
